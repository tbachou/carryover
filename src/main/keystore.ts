 ...
 * machine. That's why this file is safe to leave unencrypted-at-rest as far
 * as *this app* is concerned: the OS layer is doing the real protection.
 *
 * (Reused verbatim from Panel's src/main/keystore.ts — this is generic
 * Electron infrastructure, not domain logic, so there's no reason to
 * reinvent it.)
 */
